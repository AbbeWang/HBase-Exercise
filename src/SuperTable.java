...
public class SuperTable{
   ...
   public static void main(String[] args) throws IOException {
	...
	Put p11 = new Put(Bytes.toBytes("row3"));

p11.add(Bytes.toBytes("personal"), Bytes.toBytes("hero"), Bytes.toBytes("wolverine"));		
p11.add(Bytes.toBytes("personal"), Bytes.toBytes("power"), Bytes.toBytes("healing"));		
p11.add(Bytes.toBytes("professional"), Bytes.toBytes("name"), Bytes.toBytes("logan"));		
p11.add(Bytes.toBytes("professional"), Bytes.toBytes("xp"), Bytes.toBytes("75"));
